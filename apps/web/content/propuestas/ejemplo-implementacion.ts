 ...
 * el contenido, y registrarlo en `content/propuestas/index.ts`.
 *
 ...
 */
export const ejemploImplementacion: Propuesta = {
  ...
  bloques: [
    {
      ...
      cuerpo: [
        ...
        "Un segundo párrafo para acotar el alcance: qué entra en esta " +
          "propuesta y qué queda fuera. Conviene separar explícitamente lo que " +
          "es núcleo de producto de lo que se construye a medida, porque " +
    ...
    },
    {
      ...
      conceptos: [
        ...
        },
        {
          ...
          detalle: "Catálogos, nomenclatura propia y reglas de negocio del cliente",
          monto: "$000,000 MXN",
        },
        {
